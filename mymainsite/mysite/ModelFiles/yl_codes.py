...
lstm_model = joblib.load("../mymainsite/mysite/ModelFiles/best_lstm_final.joblib")
...
scaler_y = joblib.load("../mymainsite/mysite/ModelFiles/scaler_y.joblib")


def forecasting_with_lstm_final(lstm_model, scaler_y, steps=10):
    train_predictions = pd.read_csv("../mymainsite/mysite/ModelFiles/train_predictions.csv")

    val_predictions = pd.read_csv("../mymainsite/mysite/ModelFiles/val_predictions.csv")
    test_predictions = pd.read_csv("../mymainsite/mysite/ModelFiles/test_predictions.csv")

    # Gelecek tahminleri yap
    X_test = np.load("../mymainsite/mysite/ModelFiles/X_test.npy")
    future_predictions = []
    ...
    # print(X_test)
    train_df = pd.read_csv("../mymainsite/mysite/ModelFiles/train_df.csv")
    train_years = train_df["Year"]
    # print(train_df)
    val_df = pd.read_csv("../mymainsite/mysite/ModelFiles/val_df.csv")
    val_years = val_df["Year"]
    # print(val_df)
    test_df = pd.read_csv("../mymainsite/mysite/ModelFiles/test_df.csv")
